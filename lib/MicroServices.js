...
class Microservices {
  ...
  setConfig(opts = {}) {
    ...
    this.name = opts.name || this.skeleton.microservice.name;
    this.description = opts.description || this.skeleton.microservice.description;
    this.version = opts.version || this.skeleton.microservice.version;
    this.uuid = uuid();
    this.createAt = Date.now();
    // this.ip
    // this.port
